    ...
    <div className="absolute top-0 z-[-2] h-screen w-screen bg-[#000000] bg-[radial-gradient(#ffffff33_1px,#150229_1px)] bg-[size:40px_40px] pt-2">
      <div className="flex h-full justify-center">
        ...
        >
          ...
          <div className="border-system-purple20 bg-system-purple80 mt-6 hidden w-full gap-6 rounded border bg-opacity-10 p-4 text-gray-400 sm:flex">
            ...
            <div className="flex w-1/4 flex-col items-start justify-start gap-4">
              ...
              <p className="flex w-full flex-col gap-2 text-gray-500">
